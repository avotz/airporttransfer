...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php
			the_content( sprintf(
				wp_kses(
					...
					__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'airporttransfer' ),
					array(
						'span' => array(
							'class' => array(),
						),
			...
			wp_link_pages( array(
				'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'airporttransfer' ),
				'after'  => '</div>',
			) );
		?>
	</div><!-- .entry-content -->
	...
	<footer class="entry-footer">
		<?php airporttransfer_entry_footer(); ?>
	</footer><!-- .entry-footer -->
