	...
	<header class="header fixed py-2 border-b-2 static z-10 top-0 inset-x-0 bg-white">
		<div class="flex flex-wrap justify-between px-4 items-center">
			...
			<?php wp_nav_menu(
				...
				?>
			<a href="<?php echo esc_url(home_url('/book-now')); ?>" class="btn-book md2:block border-2 border-white hover:border-green-500 bg-green-500 px-6 py-2 text-white hover:bg-white hover:text-green-500">Book Now</a>
