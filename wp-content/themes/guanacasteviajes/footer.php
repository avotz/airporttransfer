				...
				<div class="container mx-auto text-center">
					<div class="flex flex-wrap justify-between">
						...
						<div class="footer-item w-full md:w-1/3 px-4 md:text-right mb-10">
							...
							<p class="mb-4 font-bold"> Download our app</p>
							<div>
								<a href='https://play.google.com/store/apps/details?id=com.airporttransfercostarica.customer&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1' class="block w-64"><img alt='Get it on Google Play' src='https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png' class="w-full" /></a>
								<a href="https://apps.apple.com/us/app/airport-transfer-costa-rica/id1502320287?ls=1" class="block w-64"><img src="<?php echo get_template_directory_uri();  ?>/img/Download_on_the_App_Store_Badge.svg" alt="App Store Link" class="w-full"></a>
							</div>
